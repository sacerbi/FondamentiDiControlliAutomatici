...
int main()
{
    ...
    std::ofstream dataFile("esempio3_6.dat");
    ...
    scriptFile1 << "plot 'esempio3_6.dat' using 1:2 with lines lw 2 title \"y1\", \\\n";
    scriptFile1 << "     'esempio3_6.dat' using 1:3 with lines lw 2 title \"y1 teorica\"\n";
    scriptFile1.close();
    ...
    // Plot Caso 2
    // --- 1. SALVIAMO I DATI IN UN FILE ---
    std::ofstream dataFile2("esempio3_6.dat");
    for (size_t i = 0; i < time.size(); i++)
    {
        // Scriviamo in colonne: tempo | y1 | y1 teorica
    ...
    // Plottiamo entrambe le curve nello stesso grafico per confrontarle
    scriptFile2 << "plot 'esempio3_6.dat' using 1:2 with lines lw 2 title \"y2\", \\\n";
    scriptFile2 << "     'esempio3_6.dat' using 1:3 with lines lw 2 title \"y2 teorica\"\n";
    scriptFile2.close();
    ...
    // Plot Caso 3
    // --- 1. SALVIAMO I DATI IN UN FILE ---
    std::ofstream dataFile3("esempio3_6.dat");
    for (size_t i = 0; i < time.size(); i++)
    {
        // Scriviamo in colonne: tempo | y1 | y1 teorica
    ...
    // Plottiamo entrambe le curve nello stesso grafico per confrontarle
    scriptFile3 << "plot 'esempio3_6.dat' using 1:2 with lines lw 2 title \"y3\", \\\n";
    scriptFile3 << "     'esempio3_6.dat' using 1:3 with lines lw 2 title \"y3 teorica\"\n";
    scriptFile3.close();
